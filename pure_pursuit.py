...
class PurePursuit(object):
    ...
    def __init__(self):
        ...
        self.midpoint_sub = rospy.Subscriber("lane_detection/waypoint", Float32MultiArray, self.set_waypoint)
        self.midx = 0
        self.midy = 0
        self.speed      = 0.0
        self.steering_angle_sub = rospy.Subscriber("/lane_detection/steering_angle", Float32, self.set_steering_angle)
        self.steering_angle = 0.0

        self.detected_sub = rospy.Subscriber("human_detector/detected", Bool, self.set_detected)
        self.detected = False
    ...
    def set_waypoint(self, msg):
        self.midx = msg.data[0]
        self.midy = msg.data[1]
        print(self.midx)


    def set_steering_angle(self, msg):
        self.steering_angle = msg.data
    
    def set_detected(self, msg):
